...
- **기술 스택**: 프론트엔드 - JSP / 백엔드 - Mybatis, Spring boot - Maven, hikari cp / DB - Oracle
🔎 [호텔 사이트 프로젝트](https://github.com/HubMong/hotel)
- **설명**: 단순히 주문만 하는것이 아니라 포인트를 이용하여 다양한 해택을 제공
- **역할**: 백엔드 개발, 데이터 분석
- **기술 스택**: 프론트엔드 - Vue, Axios / 백엔드 - Spring boot - Maven, JWT / DB - Maria 
🔎 [도서 판매 사이트 프로젝트]()
- **설명**: 단순히 주문만 하는것이 아니라 포인트를 이용하여 다양한 해택을 제공
- **역할**: 백엔드 개발, 데이터 분석
- **기술 스택**: 프론트엔드 - 
